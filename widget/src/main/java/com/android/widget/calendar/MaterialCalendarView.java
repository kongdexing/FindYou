...
import com.android.widget.calendar.format.ArrayWeekDayFormatter;
import com.android.widget.calendar.format.DateFormatTitleFormatter;
import com.android.widget.calendar.format.DayFormatter;
import com.android.widget.calendar.format.MonthArrayTitleFormatter;
import com.android.widget.calendar.format.TitleFormatter;
import com.android.widget.calendar.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public void gotoDate(Date date) {
        int seleteMonth = ((date.getYear() + 1900) - getMinimumDate().getYear()) * 12;
        int dateMonth = seleteMonth + date.getMonth();
        pager.setCurrentItem(dateMonth);
    }
    ...
    /**
     * Set a {@linkplain com.android.widget.calendar.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.android.widget.calendar.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.android.widget.calendar.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.android.widget.calendar.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.android.widget.calendar.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.android.widget.calendar.format.TitleFormatter)
     */
