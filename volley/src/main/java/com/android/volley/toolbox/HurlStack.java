...
public class HurlStack implements HttpStack {
    ...
    /**
     * An ceiecinterface for transforming URLs before use.
     */
...
//            Log.i("volley", "performRequest request " + headerName + ":" + map.get(headerName));
...
//                Log.i("volley", "response header  " + header.getKey() + ":" + header.getValue().get(0));
    ...
    public static void responseUpdateCookieHttpURL(CookieStore store) {
        ...
        for (HttpCookie cookie : cookies) {
            ...
            Log.i("volley", "responseUpdateCookieHttpURL cookie  " + key + ":" + value);
            cookieMap.put("Cookie", key + "=" + value);
            //        BDebug.e(HTTP_COOKIE, cookie.getName() + "---->" + cookie.getDomain() + "------>" + cookie.getPath());
        }
//        CookieUtil.setCookieMap(cookieMap);
    }
